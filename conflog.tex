...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{beckman.jpg}
...
% 	\includegraphics[width=0.4\textwidth]{marriott_room1.jpeg}		
% \end{subfigure}
% \end{figure}
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{0.5\linewidth}
		\centering
		\includegraphics[width=0.5\textwidth]{marriott_room1.jpeg}
		\caption{Marriott queen double}
	\end{subfigure}
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=0.5\textwidth]{marriott_room2.jpeg}
