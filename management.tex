...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[height=5.5cm]{stahlj.jpg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5.5cm]{dinarij.jpg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.45\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[width=0.43\textwidth]{jeckellz.png}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[height=5cm]{golbag.jpg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.35\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[height=5cm]{gaughann.JPG}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[height=5cm]{moranb.jpg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.35\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[height=5cm]{ballaa.jpg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[height=5cm]{ryann.jpg}
	\end{center}
\end{wrapfigure}
