...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5.5cm]{speaker-1.jpeg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5.5cm]{speaker-6.jpeg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5.5cm]{speaker-5.jpg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5cm]{speaker-3.jpeg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5cm]{magwoodw.jpeg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5cm]{nguyenp.png}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5.5cm]{radel.png}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.35\textwidth}
	\begin{center}
		\vspace{-\baselineskip}
		\includegraphics[height=5.5cm]{piefer.jpg}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.5\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[width=0.48\textwidth]{argonne.png}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.4\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[width=0.38\textwidth]{riggs.jpg}
...
\begin{wrapfigure}{R}{0.43\textwidth}
	\begin{center}
		% \vspace{-\baselineskip}
		\includegraphics[width=0.4\textwidth]{triptych.jpeg}
